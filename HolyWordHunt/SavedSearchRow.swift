        ...
        ZStack {
            ...
            VStack {
                ...
                HStack {
                    ...
                    Text("Books: \(search.booksToString())")
                        .padding(.leading, 40)
                    Spacer()
...
struct SavedSearchRow_Previews: PreviewProvider {
    static var previews: some View {
        SavedSearchRow(search: Search(id: 1, word: "saved", wordCount: 100, totalVerseCount: 12000, oldTestament: true, newTestament: false, bookOfMormon: true, doctrineAndCovenants: false, pearlOfGreatPrice: true)) // Random data used for testing/previewing
    }
}
